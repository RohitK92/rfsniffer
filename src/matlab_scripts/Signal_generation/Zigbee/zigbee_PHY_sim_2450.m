...
% from the IEEE(R) 802.15.4 standard [ <#5 1>], using the Communications
% System Toolbox(TM) Library for the ZigBee(R) Protocol.
...
%EcNo = -25:2.5:17.5; 
EcNo = 20;                % Ec/No range of BER curves
...
%   received = waveform;
%   bits     = lrwpan.PHYDercoderOQPSKNoSync(received,  spc, '2450 MHz');
